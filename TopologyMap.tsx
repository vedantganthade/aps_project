    ...
    <div className="relative h-full w-full overflow-hidden rounded-xl border border-slate-800/80 bg-slate-950">
      ...
      <div className="absolute inset-0">
        <svg viewBox={`0 0 ${VIEW_W} ${VIEW_H}`} className="h-full w-full" preserveAspectRatio="xMidYMid meet">
          ...
          <rect width={VIEW_W} height={VIEW_H} fill="url(#terrain-lines)" />

          {/* Stylised zone labels (subtle) */}
          <text x={100}  y={60}  fill="#1e293b" fontSize={11} fontWeight={500} letterSpacing={2}>NORTH PHOENIX</text>
          <text x={680}  y={60}  fill="#1e293b" fontSize={11} fontWeight={500} letterSpacing={2}>SCOTTSDALE</text>
          <text x={430}  y={680} fill="#1e293b" fontSize={11} fontWeight={500} letterSpacing={2}>TEMPE / MESA</text>
